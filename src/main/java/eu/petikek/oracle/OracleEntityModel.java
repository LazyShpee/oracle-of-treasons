...
public class OracleEntityModel<T extends Entity> extends CompositeEntityModel<T> implements ModelWithHead, ModelWithHat {
    ...
    public OracleEntityModel(float scale) {
        this(scale, 64, 64);
    }

    public OracleEntityModel(float scale, int textureWidth, int textureHeight) {
        float f = 0.5F;
